...
namespace Assets.Scripts.Slice_Scripts
{
    class Slicer
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static GameObject[] Slice(Plane plane, GameObject objectToCut, float massObj)
        {            
            ...
            SetupCollidersAndRigidBodys(ref positiveObject, positiveSideMeshData, sliceable.UseGravity, massObj);
            SetupCollidersAndRigidBodys(ref negativeObject, negativeSideMeshData, sliceable.UseGravity, massObj);
        ...
        private static void SetupCollidersAndRigidBodys(ref GameObject gameObject, Mesh mesh, bool useGravity, float massObj)
        {
